...
# [3] List Are Mutable(varible) => Add, Delete, Edit
# [4] List Items are Not Unique
# [5] List Can Have Different Data Types {int/float/str/boolen/list/..}
# -----------------------------
...
print(myAwesomeList)
# myAwesomeList[1] = 2
# myAwesomeList[-1] = False     (edit items in list) True>>false
myAwesomeList[0:3] = []        #>>>> index 0,1,2 become space
#myAwesomeList[0:3] = ["A"] #['A', 1, 100.5, True]      /////     'One', 'Two', 'One' >>>> 'A'
print(myAwesomeList)
