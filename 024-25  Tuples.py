...
# [4] ****** Tuple Are Immutable => You Cant Add ,Delete or update ******
...
# myAwesomeTupleFour[2] = "Three"     'tuple' object does not support item assignment
...
myTuple1 = ("Osama",)  #(,) هي اللي هتفرق بين السترينج والتابل
myTuple2 = "Osama",
...
#x, y, z = a                #Error too many value 
x,y,_,z=a                   # " _ " ignore third value 
print(x)
print(y)
print(z)
